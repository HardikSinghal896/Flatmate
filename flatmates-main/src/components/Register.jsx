...
import { useNavigate, useNavigation,Link, json} from 'react-router-dom'
...
const Register = () => {
    ...
    const handleRegister = () => {
        ...
        async function sendData(){
            // const response = await axios.post("/api/v1/push",userData);
            // handlefile();
            console.log(formdata);
            const response1 = await axios.post("http://localhost:9090/api/v1/push",formdata);
